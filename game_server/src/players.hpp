...
class Player_Manager{
  ...
  void resolve_callback(Websocket_Con *ws, int seq_id, const chat *key);
  void resolve_pick(Websocket_Con *ws, int seq_id, const chat *key);
  void resolve_details(Websocket_Con *ws, int seq_id, const chat *key);
  void resolve_update(Websocket_Con *ws, int seq_id, const chat *key);
  void resolve_score(Websocket_Con *ws, int seq_id, const chat *key);
...
void check_not_null(const char *key); // throws
